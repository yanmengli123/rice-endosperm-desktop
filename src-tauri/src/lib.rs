...
use commands::{
    ...
    list_chat_models, list_threads, load_messages, poll_device_login, remove_account,
    rename_thread, save_connection, send_message, set_chat_model_preference, start_device_login,
